  ...
  return (
    <div className="animated hero-section" style={{
      ...
      <div style={{
        ...
        <img src="/profile/satyam 444.jpg" alt="Profile" style={{width: 220, height: 220, borderRadius: '50%', objectFit: 'cover', marginBottom: 28, border: '6px solid #646cff', boxShadow: '0 0 32px 4px #a5b4fc'}} />
        <div className="portfolio-header" style={{justifyContent: 'center'}}>
          <h1 style={{fontSize: '2.6rem', marginBottom: '0.3em', letterSpacing: '2px', fontWeight: 800}}>SATYANAND YADAV</h1>
        </div>
        <h2 style={{fontWeight: 600, marginBottom: '1em', color: '#646cff', fontSize: '1.5rem'}}>Web Developer | Age 23</h2>
        <p style={{fontSize: '1.15rem', maxWidth: 400, margin: '0 auto 1.2em', lineHeight: 1.6, color: '#222', fontWeight: 500}}>
        I'm a full-stack developer passionate about building clean, user-friendly web apps using React, Tailwind, and Node.js.
Skilled in Java, DSA, and core CS concepts, I love solving real-world problems through code.
        </p>
        ...
        <div style={{display: 'flex', justifyContent: 'center', gap: '1.5rem', marginBottom: '2em'}}>
          <a href="https://github.com/Satyam00190" target="_blank" rel="noopener noreferrer" style={{
          ...
          <a href="https://www.linkedin.com/in/satyanand-yadav-004b21325?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" target="_blank" rel="noopener noreferrer" style={{
