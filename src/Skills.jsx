import { FaTools, FaHtml5, FaCss3Alt, FaJs, FaReact, FaNodeJs, FaGithub, FaJava, FaDatabase, FaCode } from 'react-icons/fa';
...
const skills = [
  ...
  { name: 'JavaScript', level: 70, icon: <FaJs color="#f7df1e" /> },
  { name: 'React', level: 85, icon: <FaReact color="#61dafb" /> },
  { name: 'Node.js', level: 65, icon: <FaNodeJs color="#3c873a" /> },
  { name: 'Express.js', level: 60, icon: <SiExpress color="#000000" /> },
  { name: 'MongoDB', level: 40, icon: <SiMongodb color="#47A248" /> },
  { name: 'Redux', level: 80, icon: <SiRedux color="#764ABC" /> },
  { name: 'RESTful APIs', level: 70, icon: <FaCode color="#FF6B6B" /> },
