      ...
      <div style={{
        ...
        <div style={{borderLeft: '3px solid #6a85b6', paddingLeft: '1.5em', marginTop: '2em', textAlign: 'left'}}>
          <div style={{marginBottom: '2em', paddingBottom: 12, borderBottom: '1.2px solid #bac8e0'}}>
            ...
            <p style={{margin: 0, fontWeight: 600, color: '#222'}}>Madan Mohan Malaviya University of Technology, Gorakhpur<br/>2024 - Present</p>
          ...
          <div>
            ...
            <p style={{margin: 0, fontWeight: 600, color: '#222'}}>RSMT, U.P. College Varanasi<br/>2019 - 2022</p>
